...
import bartr.underdogz.hackfest.util.SectionsPagerAdapter;
...
public class SearchActivity extends AppCompatActivity {
    ...
    private void setupViewPager(){
        ...
        mPagerAdapter.addFragment(new RequestFragment());
        ...
        mTabLayout.getTabAt(4).setText(getString(R.string.fragment_request));
    }
